...
const BoardPostListQueryDto = Joi.object({
    ...
    sortField: Joi.string().valid('id', 'title', 'content').default('id').messages({
...
// DTO 객체
const BoardPostListDto = {
    body: null,
    query: BoardPostListQueryDto,
    params: null
};

export default BoardPostListDto;
